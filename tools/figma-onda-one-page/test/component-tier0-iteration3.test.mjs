...
test('runtime resolves only exact direct owned component children and immediately owns repair nodes', () => {
  ...
  assert.match(source, /setRecord \? resolved\.get\(setRecord\.nodeId\)/)
  assert.match(source, /sampleRecord \? resolved\.get\(sampleRecord\.nodeId\)/)
  assert.match(source, /sample\.swapComponent\(defaultComponent\)/)
