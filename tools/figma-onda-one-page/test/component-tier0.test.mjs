...
const EXPECTED = [
  ...
  {
    id: 'icon-button', name: 'Onda/Icon Button', label: 'Icon Button', roles: [['Icon', 'TEXT'], ['State Label', 'TEXT']], labelRole: 'State Label',
    variants: [
      ['State=Default', { Icon: '+', 'State Label': 'Hinzufügen' }],
      ['State=Hover', { Icon: '↻', 'State Label': 'Neu laden' }],
      ['State=Focus', { Icon: '◎', 'State Label': 'Fokus' }],
      ['State=Disabled', { Icon: '×', 'State Label': 'Nicht verfügbar' }],
      ['State=Pressed', { Icon: '●', 'State Label': 'Gedrückt' }],
    ],
  },
  {
    id: 'status-symbol', name: 'Onda/Status Symbol', label: 'Status Symbol', roles: [['Dot', 'ELLIPSE'], ['Label', 'TEXT']], labelRole: 'Label',
    variants: [
      ['Status=Ready', { Label: 'Bereit' }],
      ['Status=Working', { Label: 'Arbeitet' }],
      ['Status=Warning', { Label: 'Prüfen' }],
...
const VARIABLE_IDS = Object.fromEntries([
  ...
  ['color/border', 'variable:border'], ['spacing/8', 'variable:spacing-8'],
