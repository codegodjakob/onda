...
// Die vier Kanaele aus Issue #12 -- Interview, Chat, Hinweis, Erweiterung. Ersetzt die vier
// verstreuten let-Sperr-Variablen aus workspace.js durch einen einzigen, kanalunabhaengigen Ort.
