...
.aura-ins__ok{height:32px;padding:0 16px;border:none;border-radius:var(--radius-full);background:var(--accent);color:var(--on-accent);font-family:var(--font-sans);font-size:var(--text-base);font-weight:var(--fw-medium);cursor:pointer;white-space:nowrap}
.aura-ins__ok:hover{background:var(--accent-hover)}
.aura-ins__no{height:32px;padding:0 14px;border:none;border-radius:var(--radius-full);background:transparent;color:var(--text-secondary);font-family:var(--font-sans);font-size:var(--text-base);font-weight:var(--fw-medium);cursor:pointer;white-space:nowrap}
...
.aura-slot__ok{height:32px;padding:0 16px;border:none;border-radius:var(--radius-full);background:var(--accent);color:var(--on-accent);font-family:var(--font-sans);font-size:var(--text-base);font-weight:var(--fw-medium);cursor:pointer}
.aura-slot__ok:hover{background:var(--accent-hover)}
.aura-slot__no{height:32px;padding:0 14px;border:none;border-radius:var(--radius-full);background:transparent;color:var(--text-secondary);font-family:var(--font-sans);font-size:var(--text-base);font-weight:var(--fw-medium);cursor:pointer}
...
function gooPath(W, H) {
  return `M 24 0 H ${W - 24} A 24 24 0 0 1 ${W} 24 V ${H - 24} A 24 24 0 0 1 ${W - 24} ${H} H 58 A 24 24 0 0 1 34 ${H - 24} V 58 A 10 10 0 0 0 24 48 A 24 24 0 0 1 0 24 A 24 24 0 0 1 24 0 Z`;
}
...
.aura-note__btn{height:32px;padding:0 16px;border:1px solid transparent;border-radius:var(--radius-full);font-family:var(--font-sans);font-size:var(--text-base);font-weight:var(--fw-medium);cursor:pointer;transition:var(--transition-colors),transform var(--dur-fast) var(--ease-out);white-space:nowrap}
...
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
const CSS = `
.aura-composer{display:flex;align-items:center;gap:8px;padding:7px 7px 7px 10px;background:var(--bg-surface);border:1px solid var(--border-default);border-radius:var(--radius-pill);transition:border-color var(--dur-fast) var(--ease-out),box-shadow var(--dur-fast) var(--ease-out),border-radius var(--dur-normal) var(--ease-out)}
...
.aura-composer__send{width:34px;height:34px;flex:none;display:inline-flex;align-items:center;justify-content:center;border:1px solid transparent;border-radius:var(--radius-full);background:var(--accent);color:var(--on-accent);cursor:pointer;transition:var(--transition-colors),transform var(--dur-fast) var(--ease-out)}
...
.aura-toast__x{flex:none;border:none;background:transparent;color:var(--text-tertiary);cursor:pointer;padding:3px;border-radius:var(--radius-full);transition:var(--transition-colors)}
...
.aura-switch__track{width:34px;height:20px;flex:none;border-radius:var(--radius-full);background:var(--ink-200);position:relative;transition:background-color var(--dur-quick) var(--ease-out),box-shadow var(--dur-fast) var(--ease-out)}
[data-theme="dark"] .aura-switch__track{background:var(--surface-3)}
.aura-switch__track::after{content:"";position:absolute;top:2px;left:2px;width:16px;height:16px;border-radius:var(--radius-full);background:#fff;box-shadow:0 1px 2px rgba(28,26,23,.2);transition:transform var(--dur-quick) var(--ease-out)}
